 ...
 *         &lt;element name="father" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="mother" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/choice&gt;
...
public class ParentsType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "father", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "mother", type = JAXBElement.class, required = false)
    })
    @XmlMixed
